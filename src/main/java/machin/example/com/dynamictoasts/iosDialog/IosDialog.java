...
import machin.example.com.dynamictoasts.R;
...
public class IosDialog {
    ...
    public IosDialog(Context context, String title, String subtitle, boolean bold, Typeface typeFace, boolean cancelable) {
        ...
        dialog.setContentView(R.layout.iosdialog_layout);
    ...
    public void setPositive(String okLabel, IosDialogListener listener) {
        this.positiveListener = listener;
        this.dismiss();
        setPositiveLabel(okLabel);
    }
    public void setNegative(String koLabel, IosDialogListener listener) {
        if (listener != null){
