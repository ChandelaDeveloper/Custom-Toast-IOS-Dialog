...
public class DianamicToast {

    public static final int LENGTH_LONG = 4000, LENGTH_SHORT = 2000, LENGTH_AUTO = 1000;
    public static final int ERROR_COLOR = 1, NORMAL_COLOR = 2, SUCCESS_COLOR = 3, WARNING_COLOR = 4, INFO_COLOR = 5, CUSTOM_COLOR = 6;
    ...
    public static void defaultToast(final Activity activity, String message, final int gravity, int duration) {
        ...
        Drawable customBackground = getbackground(CUSTOM_COLOR, view);
     ...
     */
    public static void customColorToast(final Activity activity, String message, final int gravity, int duration, @ColorRes int toastColor, @DrawableRes int icon, int backGroundColor) {
        final View view = (activity.getLayoutInflater().inflate(R.layout.toast_layout, null));

        ((TextView) view.findViewById(R.id.txtCustomToast)).setText(message);

        Drawable customBackground = getbackground(backGroundColor, view);
